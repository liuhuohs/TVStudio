package com.imooc.TVStudio.service.config;
...
import com.imooc.TVStudio.domain.constant.UserMomentsConstant;
import com.imooc.TVStudio.service.UserFollowingService;
import com.imooc.TVStudio.service.websocket.VedioSocketService;
import com.imooc.TVStudio.service.websocket.WebSocketService;
    ...
    public DefaultMQPushConsumer danmusConsumer() throws Exception{
        ...
        consumer.registerMessageListener(new MessageListenerConcurrently() {
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
                ...
                WebSocketService.VEDIOSOCKET_MAP.get(videoId);
                WebSocketService webSocketService = VedioSocketService.WEBSOCKET_MAP.get(sessionId);
